...
namespace SPW.Admin.UnitTests.Features.Congregation.Delete;
...
public class DeleteHandlerTest
{
    ...
    public DeleteHandlerTest()
    {
        ...
        _handler = new DeleteHandler(_congregationDataMock.Object, _validatorMock.Object);
    }
    ...
    public async Task Handle_WithValidRequest_ReturnResultWithGuid()
    {
        ...
        _congregationDataMock.Setup(expression => expression.GetCongregationByIdAsync(request.Id, It.IsAny<CancellationToken>()))
                        .ReturnsAsync(new CongregationEntity { Id = request.Id });
        ...
        _congregationDataMock.Verify(expression => expression.DeleteCongregationAsync(request.Id, It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task Handle_WithInvalidRequest_ReturnsResultWithError()
    {
        ...
        _congregationDataMock.Verify(expression => expression.DeleteCongregationAsync(Guid.Empty, It.IsAny<CancellationToken>()), Times.Never);
    }
}